...
import DisponibiliteItemsEmploye from '../../component/Employe/DisponibiliteItemsEmploye';



export default function DisponibiliteActuelleEmploye() {
  ...
  return (
    ...
    <View style={styles.header}>
       ...
       <FlatList 
              data={disponibilite} 
              renderItem={({item}) => (
                <DisponibiliteItemsEmploye item={item} />
              )}
