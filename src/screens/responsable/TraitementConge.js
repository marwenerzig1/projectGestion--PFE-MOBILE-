...
export default function TraitementConge() {
    ...
    const etatconge = () => {
        if(route.params.etat_conge == 0 ){
            return <Text style={styles.teext1}>En Cours</Text>
        }
        else if(route.params.etat_conge == 1){
    ...
    const AccepterConges = () => {
        var InsertAPIURL="http://"+ip_config+"/api/AccepterCongesResponsable";
    ...
    const RefuserConges = () => {
        var InsertAPIURL="http://"+ip_config+"/api/RefuserCongesResponsable";
